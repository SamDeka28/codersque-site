  ...
  return (
    <Box className={styles.container}>
        ...
        >
          {technologies.map((item, i) => (
            <motion.div
              ...
              key={i}
            >
              <TechnologyCard technology={item} key={i} />
            </motion.div>
          ))}
        </Grid>
        ...
        >
          {industries.map((item, i) => (
            <motion.div
              ...
              key={i}
            >
              <IndustryCard industry={item} key={i} />
            </motion.div>
          ))}
        </Grid>
      </div>
      ...
      <div className={styles.ideas}>
        <div className={styles.ideasLeft}>
          ...
          >
            <p className={styles.ideasTag}>
              <span className={styles.ideasSubheading}>
                Do you have a{" "}
                <span
                  style={{
                    color: "#3A0CA3",
                    fontWeight: "700",
                    borderBottom: "solid 8px #F72585",
                  }}
                >
                  Product Idea?
                </span>
              ...
              <motion.span
                ...
                className={styles.ideasHeading}
              >
                <span style={{ color: "#F72585" }}>ideas</span> to life
              </motion.span>
              <motion.span
                initial={{ translateX: -100 }}
                whileInView={{ translateX: 0 }}
        ...
        <div
          style={{ height: "100vh", position: "relative", marginTop: "2em" }}
        >
          <div
            style={{
              position: "absolute",
        ...
        >
          ...
          >
            <motion.span
              initial={{ translateX: -100 }}
              whileInView={{ translateX: 0 }}
              className={styles.contactTagHeading}
            >
              Kickstart your
            </motion.span>
            <motion.span
